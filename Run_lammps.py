...
class Run_lammps():
    ...
    def write_inputfile(self):
        with open('in.grGB','r') as inp, open(self.path+'in.grGB','w') as out:
            for line in inp:
                if line.startswith('read_data'):
                    out.write('read_data '+self.path+'modelmaster.data\n')
                else:
                    out.write(line)
    ...
    def write_lammpsdatafile(self):
        ...
        with open(self.path+'modelmaster.data','w') as f:
            ...
            #f.write(str(len(self.master.bonds))+' bond types\n')
            f.write('0 angle types\n');
            f.write('0 dihedral types\n');
            f.write('0 improper types\n');
            f.write('-10 200  xlo xhi\n');
            f.write('-10 200  ylo yhi\n');
            ...
            for at in self.master.atoms:
                if at.member:
                    f.write(str(at.lammpsid)+' '+str(1)+' '+' '+str(at.x*self.scale)+' '+str(at.y*self.scale)+' '+str(at.z*self.scale)+'\n')
#            counter=1
#            f.write('\nBond Coeffs # harmonic\n')
#            f.write('\n')
#            for bond in self.master.bonds:
#                f.write(str(counter)+str(bond.a1.lammpsid)+' '+str(bond.a2.lammpsid)+'\n')
#                counter+=1
